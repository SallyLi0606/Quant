...
if __name__ == '__main__':
    ...
    sentiment_analysis_base = "/data1/brian/Quant/news_sentiment_analysis/4-sentiment_analyzing/sentiment_outputs"
    ...
    for code_file in sorted(os.listdir(summarized_news_base)):
        ...
        code_file['title_summary'] = code_file['news_title'] + '。' + code_file['summary']
        ...
        dates, title_summaries = code_file['date'].tolist(), code_file['title_summary'].tolist()
        # 文本编码
        inputs = tokenizer.batch_encode_plus(title_summaries, max_length=max_len, return_tensors="pt", padding=True, truncation=True)
